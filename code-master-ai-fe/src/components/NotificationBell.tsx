...
const NotificationBell: React.FC = () => {
  ...
  const menuContent = (
    <div className="w-[min(360px,calc(100vw-24px))] max-w-full rounded-xl border border-gray-100 bg-white shadow-lg">
  ...
  return (
    ...
    >
      <button
        ...
        className="relative flex items-center text-2xl text-brand-700 hover:text-brand-400"
      >
